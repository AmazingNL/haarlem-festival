...
final class HistoryStBavoArticle extends BaseSection
{
    public function __construct(int $pageId = 0, int $sectionId = 0, string $customClass = '', int $sortOrder = 0)
    {
        parent::__construct($pageId, $sectionId, 'history_st_bavo_article', $customClass, $sortOrder);
    }
    ...
    public function getAdminFormFields(): array
    {
        return [
            ...
            'gallery_one_image' => ['type' => 'image', 'label' => 'First Gallery Image', 'folder' => 'history', 'prefix' => 'history-st-bavo-organ'],
            'gallery_one_caption' => ['type' => 'text', 'label' => 'First Gallery Caption'],
            'gallery_two_image' => ['type' => 'image', 'label' => 'Second Gallery Image', 'folder' => 'history', 'prefix' => 'history-st-bavo-historic'],
            'gallery_two_caption' => ['type' => 'text', 'label' => 'Second Gallery Caption'],
            'gallery_three_image' => ['type' => 'image', 'label' => 'Third Gallery Image', 'folder' => 'history', 'prefix' => 'history-st-bavo-exterior'],
