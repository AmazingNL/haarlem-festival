                ...
                <form action="/login" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="login_id" placeholder="you@example.com or username" required>
                        </div>
                    </div>
                    ...
                    <p class="signup-prompt">Don't have an account? <a href="/register">Create one</a></p>
                </form>
            </div>
        </div>
    </div>
