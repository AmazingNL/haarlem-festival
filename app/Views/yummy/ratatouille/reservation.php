...
<form method="post" action="<?= htmlspecialchars($buttonLink !== '' && $buttonLink !== '#' ? $buttonLink : '/yummy/ratatouille/book-reservation', ENT_QUOTES, 'UTF-8') ?>" class="ratatouille-booking-card">
