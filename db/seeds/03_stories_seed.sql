-- ============================================================
-- 03_stories_seed.sql
-- Seed data for the Stories landing page
-- ============================================================
-- migrate:up
...
SET @img_audience = @img_hero + 1;        -- antonio-molinari (audience)
SET @img_anansi1  = @img_hero + 2;        -- Mister Anansi
SET @img_anansi2  = @img_hero + 3;        -- Anansi portrait
SET @img_stage    = @img_hero + 4;        -- performer on stage
SET @img_crowd    = @img_hero + 5;        -- crowd
SET @img_corrie   = @img_hero + 6;        -- Corrie
SET @img_tenboom  = @img_hero + 7;        -- Ten Boom house
SET @img_drama    = @img_hero + 8;        -- drama
